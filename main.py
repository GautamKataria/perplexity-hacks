...
def main(query: str):
    # Step 1: Use AI agent to detect subject and analysis focus
    subject, focus = get_subject_and_focus_from_agent(query)
    print("subject, focus", subject, focus)
    # Step 2: Generate pillar-specific prompts
    prompts = generate_prompts(subject, focus)
    print("prompts:",prompts)
    # Step 3: Fetch Sonar responses asynchronously
    responses = asyncio.run(fetch_sonar_responses(prompts))
    print("responses:",responses)
    # Step 4: Parse pillar-aligned outputs
    structured_data = parse_sonar_responses(responses)
    print("structured_data",structured_data)
    # Step 5: Generate an executive summary
    summary = generate_360_summary(structured_data)
    print("summary",summary)
    # # Step 6: Format the final report
    # final_output = format_output(summary, structured_data)
    # print(final_output)
